...
public partial class ServerView : UserControl
{
    ...
    private async void Connect_Click(object? sender, RoutedEventArgs e)
    {
        ...
        try { await _owner.ToggleConnectAsync(Host, Port, Password); }
    ...
    private async void SaveBookmark_Click(object? sender, RoutedEventArgs e)
    {
        ...
        string? name = await Prompt.TextAsync(_owner, "Save bookmark", "Bookmark name:", suggested);
    ...
    private async void DeleteBookmark_Click(object? sender, RoutedEventArgs e)
    {
        var b = SelectedBookmark;
        if (b is null) return;
        if (!await Prompt.ConfirmAsync(_owner, "Delete bookmark",
