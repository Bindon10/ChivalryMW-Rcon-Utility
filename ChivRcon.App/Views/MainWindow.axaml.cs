...
public partial class MainWindow : Window
{
    ...
    private const int PageAudit = 7;
    private const int PageReference = 8;

    private readonly Session _session = new();
    private readonly NavItem[] _navItems =
    {
        new("Server"), new("Dashboard"), new("Map"), new("Console"),
        new("Loadout"), new("Tournament"), new("Bans"), new("Audit"), new("Reference"),
    };
    ...
    public MainWindow()
    {
        ...
        _pages = new Control[]
        {
            _server, _dashboard, _map, _console, _loadout, _tournament, _bans, _audit,
            _reference,
        };
        ...
        Nav.SelectedIndex = PageServer;
        PageHost.Content = _pages[PageServer];
    ...
    {
        if (Nav.SelectedIndex != PageConsole) _navItems[PageConsole].HasBadge = true;
    }
